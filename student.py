class student:
    def init__(self, university_id, first_name, last_name, year, sem, branch):
...
stu_1 = Student(2110030379, 'Mithun', 'Krishna', 2022, 'ODD', 'CSE')
...
print("New name of the university")